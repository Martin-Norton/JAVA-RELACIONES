 ...
 */
package ejercicio3_extra_relaciones;

import Servicio.ServicioSeguro;

/**
 *
 * @author Usario
 */
public class Ejercicio3_extra_relaciones {
...
relaciones.*/
    public static void main(String[] args) {
        ServicioSeguro serv = new ServicioSeguro();
//        serv.agregarCliente();
//        serv.mostrarCliente();
//        serv.registrarPoliza();
//        serv.agregarVehiculo();
//        serv.mostrarVehiculo();
//        serv.registrarPoliza();
//        serv.mostrarVehiculo();
          serv.menu();
    }
